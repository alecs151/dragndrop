...
function getSavedColumns() {
  if (localStorage.getItem("backlogItems")) {
    ...
    backlogListArray = ["Sit tight and enjoy", "Relax and sing a song"];
    progressListArray = ["Have to finish", "Listen to music"];
    completeListArray = ["Done, OMG", "Finally did it"];
    onHoldListArray = ["Too complicated"];
  }
}
...
// filtre arrays to remove empty arrays
